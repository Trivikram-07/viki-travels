...
const Suvs = () => {
  ...
  const suvList = Vehicles.filter(car => car.type === 'SUV');
  ...
  return (
    <Container fluid style={{ margin: '0px', padding: '20px', backgroundColor: 'bisque' }}>
      ...
      <p style={{ fontSize: '18px', color: '#666', textAlign: 'center', marginBottom: '40px', lineHeight: '1.5' }}>
        A versatile and spacious vehicle designed for both city driving and off-road adventures, offering higher ground clearance and ample cargo space.
      </p>
      <Row className="justify-content-center" style={{ gap: '120px' }}>
        {suvList.map((car, index) => (
