...
const Hatchbacks = () => {
  ...
  const hatchbackList = Vehicles.filter(car => car.type === 'Hatchback');
  ...
  return (
    <Container fluid style={{ margin: '0px', padding: '20px', backgroundColor: '#f8f9fa' }}>
      ...
      <p style={{ fontSize: '18px', color: '#666', textAlign: 'center', marginBottom: '40px', lineHeight: '1.5' }}>
        A compact and practical car with a rear door that swings upward, providing easy access to the cargo area, ideal for city driving and tight parking spaces.
      </p>
      <Row className="justify-content-center" style={{ gap: '120px' }}>
        {hatchbackList.map((car, index) => (
