...
const MPVs = () => {
  ...
  const mpvList = Vehicles.filter(car => car.type === 'MPV');
  ...
  return (
    <Container fluid style={{ margin: '0px', padding: '20px', backgroundColor: 'bisque' }}>
      ...
      <p style={{ fontSize: '18px', color: '#666', textAlign: 'center', marginBottom: '40px', lineHeight: '1.5' }}>
        A family-oriented car that provides flexible seating arrangements and generous interior space, ideal for larger groups and long-distance travel.
      </p>
      <Row className="justify-content-center" style={{ gap: '120px' }}>
        {mpvList.map((car, index) => (
